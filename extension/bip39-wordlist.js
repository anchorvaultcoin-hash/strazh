// BIP39 English wordlist - the official 2048-word list from the BIP39 spec.
//
// Verified: joining these words with newlines and hashing reproduces the
// SHA-256 of the official wordlist file:
//   2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda
// Taken from the reference implementation, not typed by hand. The test suite
// re-checks that hash, so a corrupted copy fails loudly instead of silently
...
const BIP39_WORDS = (
  ...
  "ceiling celery cement census century cereal certain chair chalk champion change chaos chapter " +
  ...
  "clarify claw clay clean clerk clever click client cliff climb clinic clip clock clog close " +
  ...
  "connect consider control convince cook cool copper copy coral core corn correct cost cotton " +
  "couch country couple course cousin cover coyote crack cradle craft cram crane crash crater " +
  "crawl crazy cream credit creek crew cricket crime crisp critic crop cross crouch crowd " +
  "crucial cruel cruise crumble crunch crush cry crystal cube culture cup cupboard curious " +
  "current curtain curve cushion custom cute cycle dad damage damp dance danger daring dash " +
  "daughter dawn day deal debate debris decade december decide decline decorate decrease deer " +
  "defense define defy degree delay deliver demand demise denial dentist deny depart depend " +
  ...
  "dose double dove draft dragon drama drastic draw dream dress drift drill drink drip drive " +
  "drop drum dry duck dumb dune during dust dutch duty dwarf dynamic eager eagle early earn " +
  "earth easily east easy echo ecology economy edge edit educate effort egg eight either elbow " +
  "elder electric elegant element elephant elevator elite else embark embody embrace emerge " +
  "emotion employ empower empty enable enact end endless endorse enemy energy enforce engage " +
  "engine enhance enjoy enlist enough enrich enroll ensure enter entire entry envelope episode " +
  "equal equip era erase erode erosion error erupt escape essay essence estate eternal ethics " +
  "evidence evil evoke evolve exact example excess exchange excite exclude excuse execute " +
  "exercise exhaust exhibit exile exist exit exotic expand expect expire explain expose express " +
  "extend extra eye eyebrow fabric face faculty fade faint faith fall false fame family famous " +
  ...
  "found fox fragile frame frequent fresh friend fringe frog front frost frown frozen fruit fuel " +
  ...
  "grunt guard guess guide guilt guitar gun gym habit hair half hammer hamster hand happy harbor " +
  "hard harsh harvest hat have hawk hazard head health heart heavy hedgehog height hello helmet " +
  "help hen hero hidden high hill hint hip hire history hobby hockey hold hole holiday hollow " +
  "home honey hood hope horn horror horse hospital host hotel hour hover hub huge human humble " +
  "humor hundred hungry hunt hurdle hurry hurt husband hybrid ice icon idea identify idle ignore " +
  "ill illegal illness image imitate immense immune impact impose improve impulse inch include " +
  "income increase index indicate indoor industry infant inflict inform inhale inherit initial " +
  "inject injury inmate inner innocent input inquiry insane insect inside inspire install intact " +
  "interest into invest invite involve iron island isolate issue item ivory jacket jaguar jar " +
  ...
  "lunar lunch luxury lyrics machine mad magic magnet maid mail main major make mammal man " +
  "manage mandate mango mansion manual maple marble march margin marine market marriage mask " +
  "mass master match material math matrix matter maximum maze meadow mean measure meat mechanic " +
  "medal media melody melt member memory mention menu mercy merge merit merry mesh message metal " +
  "method middle midnight milk million mimic mind minimum minor minute miracle mirror misery " +
  ...
  "panther paper parade parent park parrot party pass patch path patient patrol pattern pause " +
  "pave payment peace peanut pear peasant pelican pen penalty pencil people pepper perfect " +
  ...
  "process produce profit program project promote proof property prosper protect proud provide " +
  "public pudding pull pulp pulse pumpkin punch pupil puppy purchase purity purpose purse push " +
  "put puzzle pyramid quality quantum quarter question quick quit quiz quote rabbit raccoon race " +
  "rack radar radio rail rain raise rally ramp ranch random range rapid rare rate rather raven " +
  ...
  "upset urban urge usage use used useful useless usual utility vacant vacuum vague valid valley " +
  "valve van vanish vapor various vast vault vehicle velvet vendor venture venue verb verify " +
  "version very vessel veteran viable vibrant vicious victory video view village vintage violin " +
  "virtual virus visa visit visual vital vivid vocal voice void volcano volume vote voyage wage " +
  ...
  "when where whip whisper wide width wife wild will win window wine wing wink winner winter " +
  "wire wisdom wise wish witness wolf woman wonder wood wool word work world worry worth wrap " +
...
if (typeof module !== "undefined") module.exports = { BIP39_WORDS, BIP39_INDEX };
